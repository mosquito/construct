...
all_tests = [
    ...
    [BitIntegerAdapter(Field("bitintegeradapter", 8), 8, signed_value = True).parse, b("\x01") * 8, -1, None],
    ...
    [BitIntegerAdapter(Field("bitintegeradapter", 8), 8, signed_value = True).build, -1, b("\x01") * 8, None],
